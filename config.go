...
func config() (*flag.FlagSet, error) {
	...
	flags.StringVar(&B2D.SSHHost, "sshhost", "localhost", "bootstrap SSH hostname.")
	flags.StringVar(&B2D.SSHUser, "sshuser", "docker", "bootstrap SSH username.")
	flags.StringVar(&B2D.EthDev, "ethdev", "eth1", "Remote ethernet to probe for IP address.")
